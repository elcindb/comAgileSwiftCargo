Feature:  US51 Verify that Filter Text Boxes are Empty on the Salary Page

  Scenario: TC5105 Ensure that after navigating to the Salary List page under the Payroll section,
